...
admin.site.site_header = "SWAPY"
admin.site.site_title = "SWAPY Admin Portal"
admin.site.index_title = "SWAPY Admin"

# swagger
api_info = openapi.Info(
    title="SWAPY API",
    default_version="v1",
    description="API documentation for SWAPY App",
)
